...
for field_name in secondary_scalar_fields: #Iterate over any scalar fields
    ...
    create_comp_data_file(field_name, initial_month, initial_year, final_month, final_year, datdir_primary, datdir_secondary, rho_ref, time_ave_type=time_ave_type)
