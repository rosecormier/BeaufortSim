...
def comp_OkuboWeiss(grid_llc, ds_grid, mean_u, mean_v, dxC, dyC, dxG, dyG, hFacW, hFacS, drF, rA, rAz, k_val, latmin, latmax, lonmin, lonmax, resolution):
    ...
    lon_centers, lat_centers, lon_edges, lat_edges, omega_field = ecco.resample_to_latlon(ds_grid.XC, ds_grid.YC, omega.isel(k=k_val).squeeze(), latmin, latmax, resolution, lonmin, lonmax, resolution, fill_value=np.NaN, mapping_method='nearest_neighbor', radius_of_influence=120000)
