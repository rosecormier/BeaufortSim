...
from functions_field_variables import get_variable_str, field_is_primary, \
...
def load_primary_data_file(field_name, date_string, datdir_primary, 
    ...
    try: 
        #This should work for files (e.g. monthly) that come directly from ECCO
        dataset = xr.open_mfdataset(data_file_path, parallel=True, 
                                    data_vars='minimal', coords='minimal', 
                                    compat='override')
    except: 
        #This case should catch computed (e.g. seasonal) averages
