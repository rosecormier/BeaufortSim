...
Lx, Ly, Lz = 2π * 100 * 1e3, 2π * 100 * 1e3, 500 #Domain extents
...
h_diffusivity, v_diffusivity = 1e-2, 1e-6
...
p0, σr, σz = 1e5, 1e7, 1e3 #Pressure parameters
...
rho_bar(x,y,z) = -2 * p_bar(x,y,z) * z / (grav * (σz^2))

N2 = 1 #Squared BV frequency
